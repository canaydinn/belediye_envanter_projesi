/**
 * Super Admin Municipalities Edit Page Scripts Loader
 * Bu dosya, super-admin-municipalities-edit.html sayfası için gerekli tüm script dosyalarını yükler.
 */
...
(function() {
  ...
  const scripts = [
    ...
    // Super Admin Municipality Update
    { src: scriptsPath + 'js/app/super-admin-municipality-update.js', type: 'app' },
