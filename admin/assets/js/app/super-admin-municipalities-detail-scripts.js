/**
 * Super Admin Municipalities Detail Page Scripts Loader
 * Bu dosya, super-admin-municipalities-detail.html sayfası için gerekli tüm script dosyalarını yükler.
 */
...
(function() {
  ...
  const scripts = [
    ...
    // Municipality API
    { src: scriptsPath + 'js/app/super-admin-municipality-api.js', type: 'app' },
    
    // Municipality Renderer
    { src: scriptsPath + 'js/app/super-admin-municipality-renderer.js', type: 'app' },
    
    // Municipality Detail Page Logic
    { src: scriptsPath + 'js/app/super-admin-municipality-detail.js', type: 'app' },
